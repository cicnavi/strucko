<template>
    <div>
        ...
        <p>
            ...
            TOU can always be reviewed at <router-link to="/tou">TOU</router-link>.
        </p>
        <p>
        ...
        <p>
            ...
            with our <router-link to="/privacy">Privacy Policy</router-link> and
        ...
        <p>
            ...
            <router-link to="/disclaimer">Cookie Policy</router-link> for more information.
        </p>
    </div>
</template>
