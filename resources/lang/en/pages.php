...
return [
    ...
    */
    ...
    'forms.passwordconfirm' => 'Confirm Password',
    
    'login.description' => 'Login to Strucko - IT Dictionary',
    'login.title' => 'Login',
    'login.email' => 'Email',
    ...
    'password.description' => 'Reset your password - Strucko IT Dictionary',
    'password.title' => 'Reset your password',
    'password.email' => 'Email',
    'password.send' => 'Send Password Reset Link',
    
    'register.description' => 'Register on Strucko - Strucko - IT Dictionary',
    ...
    'about.description' => 'About Strucko - IT Dictionary',
    'about.title' => 'About',
    'about.header' => 'About Strucko',
    'about.about' => '
        <p>
        ...
        We have put those to the Computing scientific field.
        </p>
        <p>
    ...
    'contact.description' => 'Contact us - Strucko IT Dictionary',
    ...
    'cookie.description' => 'Cookie Policy - Strucko IT Dictionary',
    'cookie.title' => 'Cookie Policy',
    'cookie.header' => 'Cookie Policy',
    'cookie.content' => '<p>
    ...
    'disclaimer.description' => 'Disclaimer - Strucko IT Dictionary',
    ...
    'privacy.description' => 'Privacy Policy - Strucko IT Dictionary',
    'privacy.title' => 'Privacy Policy',
    'privacy.header' => 'Privacy Policy',
    'privacy.content' => '
        <p>
        Here is information on what types of personal information we receive and 
        collect when you use and visit <a href="http://strucko.com/">strucko.com</a>,
        ...
        <a href="https://tools.google.com/dlpage/gaoptout">opt out</a> if you wish.
        </p>
        <h2>Serving Ads</h2>
        <p>
        ...
        <h2>Facebook, Twitter, Google+ and other social networks, enabled by AddThis</h2>
        <p>
        ...
        <ul>
        <li>Hardware stored in secured datacentres behind firewalls</li>
    ...
    'terms.description' => 'Terms Of Use - Strucko IT Dictionary',
    'terms.title' => 'Terms Of Use',
    'terms.header' => 'Terms Of Use',
    'terms.content' => '
        <p>
        Strucko.com provides you with access to several services (suggesting new terms, 
        translations and definitions and voting on existing terms and definitions) 
        and resources (terms, their translations and definitions), 
        ...
        TOU can always be reviewed at http://strucko.com/terms-of-use.
        </p>
        <p>
        ...
        <a xmlns:cc="http://creativecommons.org/ns#" href="http://strucko.com" property="cc:attributionName" rel="cc:attributionURL">
            Strucko The Expert Dictionary
        </a> are licensed under a 
        <a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/">
        ...
        and hold harmless Strucko The Expert Dictionary from any claims, 
        ...
        <p>
        <b>4. PRIVACY POLICY AND COOKIE POLICY</b>
        <br>
        By using Strucko Services and Materials you accept and comply 
        with our <a href="/privacy-policy">Privacy Policy</a> and 
        <a href="/cookie-policy">Cookie Policy</a>.
        </p>
        <p>
        <b>3. SUPPORT SERVICES.</b>
        <br>
        Because the Strucko Services and Materials are “as is,” we may not provide 
        support services for it. See our
        <a href="http://strucko.com/disclaimer">Disclaimer</a> for more information.
        </p>',
